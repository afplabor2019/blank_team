...
class SQL
{
    ...
    public $data = LIB_PATH . 'config.php';
    public $con;
    public $options = null;
    public $stmt;
     ...
     */
    public function __construct($data = LIB_PATH . 'config.php', $options = [PDO::ATTR_EMULATE_PREPARES => false, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION], &$con = null, &$stmt = null)
    {
